...
public class Liga {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch(eleccion) {
                ...
                case 7:
                    Jugador aux = null;
                    aux =  jugadorMasRegateRecursiva(listaPer, 0, null)/*JugadorMasRegate()*/;
                    if(aux == null) {
    ...
    //-----------------------------------------------------------------------
    public static Jugador jugadorMasRegateRecursiva(ArrayList<Jugador> listaPer, int index, Jugador mejorRegateador) {
        if (index < listaPer.size()) {
            Jugador actual = listaPer.get(index);

            if (mejorRegateador == null || actual.getRegate() > mejorRegateador.getRegate()) {
                mejorRegateador = actual;
            }

            return jugadorMasRegateRecursiva(listaPer, index + 1, mejorRegateador);
        } else {
            return mejorRegateador;
        }
    }
//-------------------------------------------------------------------------//
